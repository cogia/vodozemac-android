...
public class OlmSession {
    ...
    private static native String _decrypt(final long ptr,  final String text, final long type) throws OlmException;
    ...
    public String decrypt(final OlmMessage message) throws OlmException {
